...
<head>
 ...
 -->
    ...
    <link rel="stylesheet" href="../css/rujukanstyle.css">
</head>
        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-header">
                ...
                <ul class="custom-logo">
                    ...
                    <li class="custom-logo-child">
                        <a class="logo-text custom-text-head" href="../index.php">SIAKLIK</a><br><span class="span-logo" style="color:white;">SISTEM PELAYANAN KLINIK KESEHATAN</span></a>
                    </li>
                </ul>
            </div>
        ...
        <div id="content">
            ...
            <main>
                ...
                <div class="custom-header header-wrapper">
                    <h4 align="center"><i class="fas fa-hospital-user" aria-hidden="true"></i>&nbsp;RUJUKAN BERJENJANG KE RUMAH SAKIT</h4><hr>
                </div>
                    <div class="container-fluid">
                        <div class="row" style="margin:0 auto;">
                            <div class="wrap col-xl-3">
                                <div class="primer card bg-success text-white mb-4">
                                    <div class="card-body">
                                        <h5>1. Primer</h5>
                                        <p><b>Penanganan utama :</b><br><br>
                                            Puskesmas / Dokter Keluarga / Klinik Kesehatan</p>
                                    </div>
                                </div>
                            </div>
                            <br>
                            <div class="wrap col-xl-6">
                                <div class="sekunder card bg-success text-white mb-4">
                                    <div class="card-body">
                                        <h5>2. Sekunder</h5>
                                        <p><b>Rujukan Rumah Sakit :</b><br><br>
                                            RS Haji - RS dr. Suwandi - RS BDH - RS A. Yani - RSI Jemursari - RS Pelabuhan PHC - RS Brawijaya - RS Bayangkara - RSAL Oepomo - RS Karang Tembok - BKMM - RS Al-Irsyad - RS Maji Rahayu - RS Bunda - RS Jiwa Menur</p>
                                    </div>
                                </div>
                            </div>
                            <br>
                            <div class="wrap col-xl-3">
                                <div class="tersier card bg-success text-white mb-4">
                                    <div class="card-body">
                                        <h5>3. Tersier</h5>
                                        <p><b>Rujukan Rumah Sakit :</b><br><br>
                                            RSAL dr.Ramelan - RS dr.Soetomo</p>
                                    </div>
                                </div>
                            </div>
                            <br>
                        <div class="wrap col-xl-12">
                            <div class="catatan card bg-success text-white mb-4">
                                <div class="card-body">
                                    <h5>Catatan :</h5>
                                    <p>1.&nbsp;&nbsp;Proses rujukan dimulai dari tahap Primer lalu Sekunder dan yang terakhir Tersier<br>
                                        2.&nbsp;&nbsp;Rujukan ke RS atau permintaan sendiri (APS) TIDAK DIJAMIN!<br>
                                        3.&nbsp;&nbsp;BPJS Kesehatan dapat digunakan<br><br><br>
                                        Panduan dapat anda lihat dan dapat anda download dibawah ini :<br>
                                        <a class="link" href="../assets/pdf/RUJUKANBERJENJANGKERS.pdf"><h6>--- KLIK DISINI ---</h6></a></p>
                                </div>
                            </div>
                        </div>
                    </div>

...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!-- end of navbar top -->
                ...
                <!-- DELETE ANTRIAN BPJS -->
                    <div class="modal fade" id="deleteBPJS" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            ...
                            <form action="../cruds/deleteBPJS.php" method="POST">
                                <div class="modal-body">
                                    <input type="hidden" name="delete_bpjs" id="delete_bpjs">
                                    <h4>Anda yakin akan menghapus data ini ?</h4>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                    <button type="submit" value="Submit" name="delBPJS" id="delBPJS" class="btn btn-primary">Setuju & Hapus</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <!-- DELETE ANTRIAN UMUM -->
                    <div class="modal fade" id="deleteUMUM" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">System Notification: Hapus Antrian</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                
                            <form action="../cruds/deleteUMUM.php" method="POST">
                                <div class="modal-body">
                                    <input type="hidden" name="delete_umum" id="delete_umum">
                                    <h4>Anda yakin akan menghapus data ini ?</h4>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                    <button type="submit" value="submit" name="delUMUM" id="delUMUM" class="btn btn-primary">Setuju & Hapus</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <!-- DELETE ANTRIAN INTERNAL -->
                    <div class="modal fade" id="deleteINTERN" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">System Notification: Hapus Antrian</h5>
                            ...
                            <form action="../cruds/deleteINTERN.php" method="POST">
                                <div class="modal-body">
                                    <input type="hidden" name="delete_intern" id="delete_intern">
                                    <h4>Anda yakin akan menghapus data ini ?</h4>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                    <button type="submit" value="Submit" name="delINTERN" id="delINTERN
                                    " class="btn btn-primary">Setuju & Hapus</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="table-responsive">
                ...
                <table id="datatableid" class="table table-bordered" style="width:100%">
                    ...
                    <tr>
                        ...
                        <th scope="col" style="padding:10px;">NAMA PASIEN</th>
                        <th scope="col" style="padding:10px;">TANGGAL</th>
                    ...
                    <tbody>
                    <?php include '../cruds/searchBpjs.php';
                    ...
                    <tr>
                        ...
                        <td data-label="tanggal" style="padding:5px;"> <?php echo $row['tanggal']; ?> </td>
                        <td data-label="status" style="padding:5px;"> <?php echo $row['status']; ?> </td>
                        <td scope="row" style="padding:5px;">
                        <div class="btn-group mr-2" role="group" aria-label="First group">
                            <a href="#" class="btn btn-danger btn-sm delBPJS" data-toggle="modal" data-target="#deleteBPJS"><i class="fa fa-trash"></i></a>
                        </div>
                        </td>
                    </tr>
                    </tbody>
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <?php if(isset($total_page)) {
                                ...
                                <div class="left">
                                    <a class="btn-page btn btn-success" href="../poli/data_antrian.php?link=<?php echo $page-1; ?>"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Back</a>
                                </div>
                            &nbsp;&nbsp;
                            <?php }
                                if($page<$total_page) { ?>
                                ...
                                <div class="right">
                                    <a class="btn-page btn btn-success" href="../poli/data_antrian.php?link=<?php echo $page+1; ?>">Next&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></a>
                                </div>
                            <?php 
                                } 
                              }
    ...
    <!-- End of Main -->
            ...
            <div class="table-responsive">
                ...
                <table id="datatableid" class="table table-bordered" style="width:100%">
                    ...
                    <tbody>
                    <?php include '../cruds/searchUmum.php';
                    ...
                    <tr>
                        <td scope="row" style="padding:5px;"> <?php echo $row['id_antrian']; ?> </td>
                        <td data-label="kode_antrian" style="padding:5px;"> <?php echo $row['kode_antrian']; ?> </td>
                        <td scope="row" style="padding:5px;"> <?php echo $row['nama_pasien']; ?> </td>
                        <td data-label="tanggal" style="padding:5px;"> <?php echo $row['tanggal']; ?> </td>
                        <td data-label="status" style="padding:5px;"> <?php echo $row['status']; ?> </td>
                        <td scope="row" style="padding:5px;">
                        <div class="btn-group mr-2" role="group" aria-label="First group">
                            <a href="#" class="btn btn-danger btn-sm delUMUM" data-toggle="modal" data-target="#deleteUMUM"><i class="fa fa-trash"></i></a>
                        </div>
                        </td>
                    </tr>
                    </tbody>
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <?php if(isset($total_page)) {
                                ...
                                <div class="left">
                                    <a class="btn-page btn btn-success" href="../poli/data_antrian.php?link1=<?php echo $page-1; ?>"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Back</a>
                                </div>
                            &nbsp;&nbsp;
                            <?php }
                                if($page<$total_page) { ?>
                                ...
                                <div class="right">
                                    <a class="btn-page btn btn-success" href="../poli/data_antrian.php?link1=<?php echo $page+1; ?>">Next&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></a>
                                </div>
                            <?php 
                                } 
                              }
    ...
    <!-- Antrian Pasien Internal -->
            ...
            <div class="table-responsive">
                ...
                <table id="datatableid" class="table table-bordered" style="width:100%">
                    ...
                    <tbody>
                    <?php include '../cruds/searchIntern.php';
                    ...
                    <tr>
                        ...
                        <td scope="row" style="padding:5px;">
                        <div class="btn-group mr-2" role="group" aria-label="First group">
                            <a href="#" class="btn btn-danger btn-sm delINTERN" data-toggle="modal" data-target="#deleteINTERN"><i class="fa fa-trash"></i></a>
                        </div>
                        </td>
                    </tr>
                    </tbody>
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <?php if(isset($total_page)) {
                                ...
                                <div class="left">
                                    <a class="btn-page btn btn-success" href="../poli/data_antrian.php?link2=<?php echo $page-1; ?>"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Back</a>
                                </div>
                            &nbsp;&nbsp;
                            <?php }
                                if($page<$total_page) { ?>
                                ...
                                <div class="right">
                                    <a class="btn-page btn btn-success" href="../poli/data_antrian.php?link2=<?php echo $page+1; ?>">Next&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></a>
                                </div>
                            <?php 
                                } 
                              }
    ...
    <script src="../assets/js/deleteBPJS.js"></script>
    <script src="../assets/js/deleteUMUM.js"></script>
    <script src="../assets/js/deleteINTERN.js"></script>

            ...
            <main>
                <section class="pendaftaran">
                    ...
                    <div class="content" style="margin-bottom:80px;">           
                        <img class="alurpoli" src="../assets/images/alurpoli.png">
                    </div>
                    <div class="container-fluid">
                        <div class="row" style="margin:0 auto;">
                            <div class="wrap col-xl-12">
                                <div class="offline card bg-info mb-4">
                                    <div class="card-body">
                                        <center><h5 title="offline">1. OFFLINE</h5></center>
                                        <p class="pr" align="justify">Pasien bisa datang langsung ke lokasi pendaftaran yang ada pada <b>Klinik</b>. Verifikasi data tidak dipungut biaya. Pasien nantinya diharapkan ke ruang tunggu untuk dipanggil sesuai dengan no antriannya. Pembayaran dilakukan secara transparan ketika pasien selesai berobat.</p><br>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="wrap col-xl-12">
                                <div class="online card bg-info mb-4">
                                    <div class="card-body">            
                                        <center><h5 title="online">2. ONLINE</h5></center>
                                        <p class="pr" align="justify">Pasien dapat mendaftar secara online dengan melakukan aktifitas login terlebih dahulu, lalu memilih opsi pada menu <b>DAFTAR ANTRIAN</b>. Setelah itu, pasien mengisi form pendaftaran untuk mendapatkan kuota antrian pada POLI tertentu. Kemudian, pasien diharapkan datang langsung ke Klinik untuk melakukan verifikasi data dan pasien nantinya diharapkan ke ruang tunggu untuk dipanggil sesuai dengan no antriannya. Pembayaran dilakukan secara transparan ketika pasien selesai berobat.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <style>
                        .alurpoli{
                            margin-left:50px;width:90%;height:100%;
                        }
                        .offline, .online{
                            color:#00ffff;
                            font-weight:bold;

...
if(isset($_POST['register'])){
    ...
    if(!uniq_email($email)) {
        ...
        $result = insert("INSERT INTO pekerja_klinik(email_klinik, nama_klinik, password_klinik, username)  VALUES('$email','$nama','$pwd','$username')");
        if($result == 1){
            Works();
...
<head>
    ...
    <!-- Desc page -->
    <title>Poliklinik UPN "VETERAN" JAWA TIMUR</title>
    <meta name="description" content="Website fasilitas dari Poliklinik UPN VETERAN JAWA TIMUR">
    <meta name="keywords" content="Poliklinik, upnjatim, upn, klinik, surabaya, rungkut, kampus, klinik kampus, bpjs" />
        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-header">
                ...
                <ul class="custom-logo">
                    ...
                    <li class="custom-logo-child">
                        <a class="logo-text custom-text-head" href="../index.php">POLIKLINIK<br><span class="span-logo" style="color:white;">UPN VETERAN JAWA TIMUR</span></a>
                    </li>
                    <li class="custom-logo-child mb-0">
                        <p class="mb-0"><i class="online-A fas fa-circle"></i>SUPER ADMIN</p>
                    </li>
                </ul>
            </div>
                ...
                <section class="register-section">
                    <div class="container form-register">
                        <div class="form-header">
                            <h5><i class="fas fa-plus"></i>Tambah Akun Pekerja Klinik</h5>
                        </div>
                        <hr class="">
                        <div class="col-md-12">
                            <div class="col-md-8">
                ...
                <div class="container-fluid text-center text-md-left">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-md-0 mt-3">
                            <!-- Content -->
                            <h5 class=""><i class="footer-icons fas fa-map-marker-alt"></i>Alamat Poliklinik UPN</h5>
                        ...
                        <div class="col-md-3 mb-md-0 mb-3">
                            <!-- Links -->
                            <h5 class=" "><i class="footer-icons fas fa-external-link-alt"></i>Halaman Lainnya</h5>
                            <ul class="custom-footer-hover list-unstyled font-weight-normal">
                                <li>
                                    <a href="https://www.upnjatim.ac.id/en/" target="_blank">UPN Veteran Jatim</a>
                                </li>
                                <li>
                                    <a href="https://siamik.upnjatim.ac.id/" target="_blank">SIAMIK</a>
                                </li>
                                <li>
                                    <a href="https://simaba.upnjatim.ac.id/" target="_blank">SIMABA</a>
                                </li>
                                <li>
                                    <a href="https://sidos.upnjatim.ac.id/" target="_blank">SIDOS</a>
                                </li>
                            </ul>
                        </div>
                        <!-- End Grid column -->
                        ...
                        <div class="col-md-3 mb-md-0 mb-3">
                            ...
                            <ul class="list-unstyled font-weight-normal">
                                ...
                                <li>
                                    <a>poliklinik@upnvjatim.ac.id</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Grid column -->

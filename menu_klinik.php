...
<head>
 ...
 -->
    ...
    <link rel="stylesheet" href="css/menu-klinik.css">
</head>
...
<body>
    ...
    <div class="wrapper">
            ...
            <ul class="list-unstyled components custom-menu-bar">
                ...
                <li class="custom-menu-sidebar active">
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        ...
                        <li>
                            <a href="index.php?#visi_misi"><i class="fas fa-comment-dots"></i>Visi dan Misi</a>
                        </li>
                        <li>
                ...
                <li class="custom-menu-sidebar">
                    ...
                    <ul class="collapse list-unstyled" id="pageArtikel">
                        ...
                        <li>
                            <a href="assets/pdf/pneumonia.pdf"><i class="fas fa-bookmark"></i>PNEUMONIA</a>
                        </li>
                        <li>
                            <a href="assets/pdf/difteri.pdf"><i class="fas fa-bookmark"></i>DIFTERI</a>
                        </li>
                        <li>
                            <a href="assets/pdf/dbd.pdf"><i class="fas fa-bookmark"></i>DEMAM BERDARAH DENGUE</a>
                        </li>
                        <li>
        ...
        <div id="content">
            ...
            <main>
                <!--<hr class="solid">-->
                 <section class="menu-klinik">
                    <div class="container-fluid klinik-menu">
                        <div class="klinik-header">
                            <h5><i class="fas fa-user-md"></i>Menu Halaman Utama Pekerja Klinik</h5>
                        </div>
                        <hr>
                        <div class="row klinik-item">
                            <a href="poli/data_pasien.php" class="btn btn-square btn-primary custom-btn-klinik data-pasien">
                                <i class="fas fa-address-book"></i><br>
                                Data Pasien Klinik
                            </a>
                            <a href="poli/data_antrian.php" class="btn btn-square btn-success custom-btn-klinik antrian-pasien">
                                <i class="fas fa-user-friends"></i><br>
                                Antrian Pasien Klinik
                            </a>
                            <a href="grafik/grafik.php" class="btn btn-square btn-secondary custom-btn-klinik diagram-pasien">
                                <i class="fas fa-chart-pie"></i><br>
                                Diagram Tahunan
                            </a>
                            <!--<a href="#" class="btn btn-outline-warning custom-btn-klinik masuk-admin disabled">-->
                            <!--    <i class="fas fa-user-check"></i>&nbsp;<i class="fas fa-sign-in-alt"></i><br>-->
                            <!--    Masuk sebagai Admin-->
                            <!--</a>-->
                        </div>
                    </div>
                ...
                <!--        <div class="klinik-header">-->
                <!--            <h5><i class="fas fa-user-cog"></i>Menu Konfigurasi Admin Pekerja Klinik</h5>-->
                <!--        </div>-->
                <!--        <hr class="solid">-->
                <!--        <div class="row klinik-item">-->
                <!--            <a href="#" class="btn btn-outline-primary custom-btn-klinik masuk-admin disabled">-->
                <!--                <i class="fas fa-user-plus"></i><br>-->
                <!--                Tambah Akun-->
                <!--            </a>-->
                <!--            <a href="#" class="btn btn-outline-success custom-btn-klinik masuk-admin disabled">-->
                ...
                <!--                Edit Akun-->
                <!--            </a>-->
                <!--            <a href="#" class="btn btn-outline-danger custom-btn-klinik masuk-admin disabled">-->

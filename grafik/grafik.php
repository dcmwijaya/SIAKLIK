...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!-- body -->
            <main>
                <section class="grafik-info">
                        <div class="custom-header header-wrapper" align="center">
                            <h4><i class="far fa-chart-bar" aria-hidden="true"></i>&nbsp;GRAFIK KUNJUNGAN PASIEN</h4>
                            <p>Daftar grafik kunjungan pasien pada Klinik per tahun</p>
                        </div>
                        <br><br>
                        <div class="alert alert-primary" role="alert"><a href="../grafik/Grafik-kelamin.php"><i class="far fa-chart-bar"></i><b>&nbsp;&nbsp;Grafik Kunjungan Pasien Berdasarkan Jenis Kelamin</b></a></div>
                        <div class="alert alert-secondary" role="alert"><a href="../grafik/Grafik-2013.php"><i class="far fa-chart-bar"></i><b>&nbsp;&nbsp;Grafik Kunjungan Pasien Berdasarkan Satker Tahun 2013</b></a></div>
                        <div class="alert alert-success" role="alert"><a href="../grafik/Grafik-2014.php"><i class="far fa-chart-bar"></i><b>&nbsp;&nbsp;Grafik Kunjungan Pasien Berdasarkan Satker Tahun 2014</b></a></div>
                        <div class="alert alert-danger" role="alert"><a href="../grafik/Grafik-2015.php"><i class="far fa-chart-bar"></i><b>&nbsp;&nbsp;Grafik Kunjungan Pasien Berdasarkan Satker Tahun 2015</b></a></div>
                        <div class="alert alert-warning" role="alert"><a href="../grafik/Grafik-2016.php"><i class="far fa-chart-bar"></i><b>&nbsp;&nbsp;Grafik Kunjungan Pasien Berdasarkan Satker Tahun 2016</b></a></div>
                        <div class="alert alert-info" role="alert"><a href="../grafik/Grafik-2017.php"><i class="far fa-chart-bar"></i><b>&nbsp;&nbsp;Grafik Kunjungan Pasien Berdasarkan Satker Tahun 2017</b></a></div>
                        <div class="alert alert-dark" role="alert"><a href="../grafik/Grafik-2018.php"><i class="far fa-chart-bar"></i><b>&nbsp;&nbsp;Grafik Kunjungan Pasien Berdasarkan Satker Tahun 2018</b></a></div>
                        <div class="alert alert-primary" role="alert"><a href="../grafik/Grafik-2019.php"><i class="far fa-chart-bar"></i><b>&nbsp;&nbsp;Grafik Kunjungan Pasien Berdasarkan Satker Tahun 2019</b></a></div>
                        <div class="alert alert-danger" role="alert"><a href="../grafik/Grafik-2020.php"><i class="far fa-chart-bar"></i><b>&nbsp;&nbsp;Grafik Kunjungan Pasien Berdasarkan Satker Tahun 2020</b></a></div>
                    </figure>
                </section>
            </main>
            <!-- End of Main -->
